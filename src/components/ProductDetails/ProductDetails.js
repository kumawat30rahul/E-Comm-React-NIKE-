      ...
      <div className="prdt_details">
        ...
        <div className="prdt_info">
            ...
            <div className="sizes">
              {sizes.map((size) => (
                <button
                  ...
                  className={`shoe-size ${sizeSelect === size ? "active" : ""}`}
                >{`${size}`}</button>
              ))}
            </div>
          </div>
          <button
            ...
            onClick={() => addingTocart(cardData)}
          >
            Add to Cart
          </button>
          <button
            className="wishlist-btn btn"
            onClick={() => addingToFav(cardData)}
          >
            Add to <FavoriteBorderRoundedIcon />
          </button>
